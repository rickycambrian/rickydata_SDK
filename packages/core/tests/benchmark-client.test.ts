...
describe('BenchmarkClient', () => {
  ...
  it('passes benchmark proof and trace fields when recording runs', async () => {
    ...
    await client.recordRun({
      ...
      runtime_family: 'rickydata-cli',
      execution_backend: 'rickydata-cli',
      config_name: 'anthropic-haiku-4.5-rickydata-cli-single',
      actual_cost_usd: 0.0034688,
      cost_metrics: {
        input_tokens: 3231,
        output_tokens: 221,
        total_tokens: 3452,
        estimated_cost_usd: 0.0034688,
        cost_per_quality_point: 0.0069376,
        tokens_per_file_changed: 3452,
      },
